...
config :goalmatic_ex_as1036, GoalmaticExAs1036Web.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Bix867YJxVzisPeq3xEFVXhkggvduBmDG1SskB2h7Y4roBaHTP05wxXfplgaaq4G",
  watchers: [
...
config :goalmatic_ex_as1036, GoalmaticExAs1036Web.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/goalmatic_ex_as1036_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :goalmatic_ex_as1036, dev_routes: true
