defmodule GoalmaticExAs1036Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GoalmaticExAs1036Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GoalmaticExAs1036Web.Gettext, "errors", msg, opts)
    end
  end
